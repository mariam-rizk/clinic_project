                ...
                <div class="card-header">
                    <div class="card-tools">
                        <form method="GET" class="input-group input-group" style="width: 250px;">
                            ...
                            <input type="text" name="search" class="form-control float-right" placeholder="Search by name" value="<?= htmlspecialchars($search ?? '') ?>">
                            ...
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (Session::get('admin_user')['role'] === 'admin'): ?>
