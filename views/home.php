            ...
            <div class="d-flex flex-wrap gap-4 justify-content-center">
                <div class="card p-2" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        ...
                        <a href="?page=doctors" class="btn btn-outline-primary card-button">Browse Doctors</a>
                    </div>
                </div>
                <div class="card p-2" style="width: 18rem;">
                    <img src="assets/images/major.jpg" class="card-img-top rounded-circle card-image-circle"
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    ...
                                    <a href="?page=doctors" class="btn btn-outline-primary card-button">Book an
                                        appointment</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    <h4 class="card-title fw-bold text-center">Doctor Name</h4>
                                    <h6 class="card-title fw-bold text-center">Major</h6>
                                    <a href="?page=doctors" class="btn btn-outline-primary card-button">Browse
                                        Doctors</a>
                                </div>
                            </div>
                        </li>
