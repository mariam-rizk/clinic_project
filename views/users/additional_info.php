...
$info = $infoModel->getByUserId($userId);
?>
    ...
    <div class="card shadow-sm p-4">
        ...
        <form action="?page=additional_info_controller" method="post" class="needs-validation" novalidate>
            <div class="mb-3">
                ...
                <textarea name="address" id="address" class="form-control <?= isset($old['address']) ? 'is-invalid' : '' ?>" rows="3" required><?= htmlspecialchars($info['address'] ?? $info['address']?? '') ?></textarea>
